...
public class Cop28SceneManager : MonoBehaviour
{
    #region Variables
    ...
    [SerializeField] private List<bool> levelNum = new List<bool>();
    ...
    [HideInInspector] private bool loadSceneIsCalled = false;
    ...
    void Update()
    {
        CheckCurrentDialouge1();
        CameraStages1();
        //if (levelNum[0] == true) // for dialouge level
        //{
        //    CheckCurrentDialouge1();
        //    CameraStages1();
        //}
        //else if (levelNum[1] == true) // for tutorial level
        //{

        //}
        //else 
        //{
        //    print("ERORR Pick check on one of the levelNum boolens!");
        //}
    }
    void CameraStages1()
    {
    ...
    void EndScreen()
    {
        ...
        {
            if (!loadSceneIsCalled)
            {
                loadSceneIsCalled = true;
                //end scene and move to next one OR show the end level screen where the player can choose Main menu or next level.
